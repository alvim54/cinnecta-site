      ...
      <header>
        <div className="grid-x align-middle">
          ...
          <div className="cell small-6 medium-auto">
            <nav className={'main-menu' + (this.state.isMobileMenuActive ? ' is-active' : '')}>
                <div className="toggle-menu" onClick={() => this.setState({ isMobileMenuActive: !this.state.isMobileMenuActive })}>
